...
Formally,
{% include figure.html path="assets/img/causal_inference_notes/4.png" class="img-fluid rounded z-depth-1" zoomable=true %}
{% include figure.html path="assets/img/causal_inference_notes/5.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.html path="assets/img/causal_inference_notes/6.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.html path="assets/img/causal_inference_notes/7.png" class="img-fluid rounded z-depth-1" zoomable=true %}
...
{% include figure.html path="assets/img/causal_inference_notes/8.png" class="img-fluid rounded z-depth-1" zoomable=true %}



{% include figure.html path="assets/img/causal_inference_notes/9.png" class="img-fluid rounded z-depth-1" zoomable=true %}
